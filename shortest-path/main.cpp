...
int main()
{
  Graph graph;
	...
	if(!(graph.addEdge(1,2, 16) && graph.addEdge(1,3,4)&&
			graph.addEdge(1,4,8)&& graph.addEdge(2,5,2)&&
			graph.addEdge(3,4,3)&& graph.addEdge(4,2,7)&&
			graph.addEdge(6,2,5)&&graph.addEdge(6,5,6))
	)
	{
		cout<<"Add edge error!\n";
		exit(-1);
